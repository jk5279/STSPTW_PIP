...
**Running the full v2 evaluation sweep** (recommended over calling `test.py` manually):
...
|---|---|---|
| `scripts/train/sweep_v1.sh` | 54 v1 training runs (SLURM array, N=10) | — |
| `scripts/train/sweep_v2.sh` | 54 v2 training runs (SLURM array, N=10) | — |
| `scripts/train/sweep_v2_n50.sh` | 54 v2 training runs (SLURM array, N=50) | batch=1024 |
| `scripts/train/sweep_v2_n100.sh` | 54 v2 training runs (SLURM array, N=100) | batch=512 |
| `scripts/test/run_test_v2.py` | Evaluate all trained v2 models | noise seed 42 hardcoded |
| `scripts/test/benchmarks/run_test_sweep_v1_v2.py` | Evaluate all 108 v1+v2 N=10 models | — |
| `scripts/test/benchmarks/run_test_pomo_star_posthoc_pip.py` | POMO* checkpoints + PIP post-hoc | — |

Submit jobs:

```bash
sbatch scripts/train/sweep_v2_n50.sh
sbatch scripts/train/sweep_v2_n100.sh
sbatch scripts/test/run_test_v2.sh
```
