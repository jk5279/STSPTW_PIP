...
class SINGLEModel(nn.Module):
    ...
    def pre_forward(self, reset_state):
        ...
        elif self.problem in ["TSPTW", "TSPTW_SPIP", "STSPTW", "STSPTW_v2"]:
...
class SINGLE_Encoder(nn.Module):
    def __init__(self, **model_params):
        ...
        elif self.problem in ["TSPTW", "TSPTW_SPIP", "STSPTW", "STSPTW_v2", "TSPDL"]:
...
class SINGLE_Decoder(nn.Module):
    def __init__(self, **model_params):
        ...
        elif self.problem in ["VRPB", "TSPTW", "TSPTW_SPIP", "STSPTW", "STSPTW_v2", "TSPDL"]:
            self.Wq_last = nn.Linear(embedding_dim + 1, head_num * qkv_dim, bias=False)
            if self.model_params["pip_decoder"]:
                self.Wq_last_sl = nn.Linear(embedding_dim + 1, head_num * qkv_dim, bias=False)
